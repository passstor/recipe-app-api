"""
Тестування API для інгредієнтів
"""
...
class PublicIngredientsApiTests(TestCase):
    """Тестування публічного API для інгредієнтів"""
...
class PrivateIngredientsApiTests(TestCase):
    """"Тестування приватного API для інгредієнтів"""
    ...
    def test_retrieve_ingredient_list(self):
        """Тестування отримання списку інгредієнтів"""
    ...
    def test_ingredients_limited_to_user(self):
        """Тестування, що інгредієнти повертаються для користувача"""
        user2 = create_user(
    ...
    def test_filter_assigned_to_recipes(self):
        """Тестування повернення інгредієнтів, які призначені рецептам"""
    ...
    def test_filter_ingredients_unique(self):
        """Тестування повернення унікальних інгредієнтів"""
